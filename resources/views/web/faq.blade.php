            ...
            <div class="regis__forms">
                <div class="regis__registre">
                    ...
                    <center style="font-size: 1rem; font-weight: 500">
                        Open Recruitment HIMSI UNSRI 2025
                    </center>
                    ...
                    <div class="please-read">
                        <div class="alert alert-primary text-center text-primary fw-bold" role="alert">
                            YUK DIBACA!!!
                        </div>
                    </div>
                    ...
                    <div class="accordion" id="accordionExample">
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                                data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    <strong>Untuk Divisi PTI apakah harus jago
                                        ngoding?</strong>
                                    Tentu tidak, tetapi minimal memiliki pengetahuan serta kemampuan dasar dalam membuat
                                    website sederhana dengan penggunaan HTML, CSS, dan JavaScript. Yang pastinya jika
                                    tergabung di divisi PTI akan selalu dibimbing untuk terus belajar dan berkembang.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree"
                                data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    <strong>Untuk pas foto apakah harus formal atau non
                                        formal?</strong>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingThree"
                                data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    <strong>Apakah harus mempunyai pengalaman
                                        organisasi?</strong>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingThree"
                                data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    <strong>Apakah boleh daftar himsi kalau sudah ada
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseSix" class="accordion-collapse collapse" aria-labelledby="headingThree"
                                data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    <strong>Apakah boleh mencoba daftar lebih dari satu organisasi eksekutif internal
                                        fasikom?</strong>
                                    Mahasiswa hanya diperbolehkan mengikuti open recruitment 1 organisasi eksekutif internal
                                    Fasilkom Unsri.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseSeven" class="accordion-collapse collapse" aria-labelledby="headingThree"
                                data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    <strong>Apa saja persyaratan untuk mendaftar
                                        himsi?</strong>
                                    <br />
                                    <ol>
                                        <li>
                                            Mahasiswa Aktif SI UNSRI angkatan 2024
                                        </li>
                                        <li>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseEight" class="accordion-collapse collapse" aria-labelledby="headingThree"
                                data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    <strong>Apakah kartu KHS harus sudah
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseTen" class="accordion-collapse collapse" aria-labelledby="headingThree"
                                ...
                                <div class="accordion-body">
                                    ...
                                    digunakan untuk dokumentasi kegiatan HIMSI sangat diperbolehkan.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseTwelve" class="accordion-collapse collapse" aria-labelledby="headingThree"
                                data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    <strong>Apa yang harus dilakukan jika berhalangan hadir pada tes wawancara oprec
                                        nanti?</strong>
                                    Jika berhalangan hadir pada tes wawancara harap segera melapor ke pihak panitia dan
                                    tentu nantinya akan dibantu untuk melakukan wawancara susulan.
                                </div>
                            </div>
                        </div>
