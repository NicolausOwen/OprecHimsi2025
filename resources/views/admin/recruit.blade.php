...
@section('index')
    ...
    <div class="content-wrapper container">
        ...
        <section class="section">
            <div class="card">
                <div class="card-body">
                    <table class="table table-striped" id="tableSemua" style="width: 100%">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>Nama</th>
                        ...
                        <tbody>
                            @foreach ($divisi['Semua'] as $row => $col)
                                <tr>
                                    ...
                                    <td>{{ $col['nama'] }}</td>
                                    <td>
                                        <a href="https://line.me/ti/p/{{ $col['idline'] }}"
                                            target="_blank">{{ $col['idline'] }}</a>
                                    </td>
                                    <td>
                                        <a href="https://instagram.com/{{ $col['instagram'] }}"
                                            target="_blank">{{ $col['instagram'] }}</a>
                                    </td>
                                    <td>{{ $col['pil1'] }}</td>
                                    <td>{{ $col['pil2'] }}</td>
                                    ...
                                    <td>
                                        <a href="#" class="btn btn-success" data-bs-toggle="modal"
                                            data-bs-target="#myModal{{ $col['id'] }}"
                                            style="font-size: .9rem;">Recruit</a>
                                        <a href="{{ route('profil', $col['id']) }}"><button
                                                class="btn btn-primary btn-floating"
                                                style="font-size: .9rem;">Lihat</button></a>
                                    </td>
                                </tr>
                                <div class="modal fade text-left" id="myModal{{ $col['id'] }}" role="dialog"
