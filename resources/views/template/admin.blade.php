...
<head>
    ...
    <link rel="stylesheet"
        href="{{ url('assets_admin/vendor/jquery-datatables/jquery.dataTables.bootstrap5.min.css') }}">
                ...
                <div class="header-top pt-3 pb-2">
                    <div class="container">
                        <div class="logo" style="display: inline-flex;">
                            <h4 class="pt-1">OPREC BPH 2025</h4>
                        </div>
                        ...
                        <ul>
                            ...
                            <li class="menu-item">
                                <form action="{{ route('adminLogout') }}" method="post">
                                    @csrf
                                    <button type="submit"
                                        class='submenu-link btn btn-warning text-dark'>Logout</button>
                                </form>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="container">
                    <div class="footer clearfix mb-0 text-muted">
                        <div class="float-start">
                            <p>2021 &copy; PTI - OPREC BPH 2025</p>
                        </div>
                        <div class="float-end">
