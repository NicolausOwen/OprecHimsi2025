...
<head>
    ...
    <meta name="description" content="Open Recruitment HIMSI Fasilkom Unsri 2025" />
    <meta name="author" content="RISTEK HIMSI 2025/2025" />
    ...
    <link rel="stylesheet" href="{{ url('assets/css/owl.theme.css') }}" type="text/css" />
    ...
    <link rel="stylesheet" href="{{ url('assets/vendor/sweetalert/js/sweetalert2.min.css') }}" />
    ...
    <!--===== COLOR SCEME ===== -->
    <link rel="stylesheet" href="{{ url('assets/css/colors/orange.css') }}" type="text/css" />
...
<style>
    ...
    .background {
        ...
        width: 100%;
        height: 100%;
        background: url('../../img/himsi.jpg') center/cover no-repeat;
